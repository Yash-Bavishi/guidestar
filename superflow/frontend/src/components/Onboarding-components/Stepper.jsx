...
export function ProgressStepper(props) {
  if (props.status !== "last") {
    if (props.ele === "active") {
      return (
        <>
          <div className="stepperNumberActive stepperNumber">
            0{props.index + 1}
          </div>{" "}
          <HalfProgress />
        </>
      ...
      return (
        <>
          <div className="stepperNumberInactive stepperNumber">
            0{props.index + 1}
          </div>
          <NoProgress />
        </>
    ...
    return (
      <>
        <div className="completeNumber">
          ...
          >
            <path
              d="M3.3335 8.49984L6.66683 11.8332L13.3335 5.1665"
              stroke="white"
              strokeWidth="1.5"
              strokeLinecap="round"
