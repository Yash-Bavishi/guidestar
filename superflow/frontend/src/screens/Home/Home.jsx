...
import "./Home.css";
import ProjectInfo from "../../components/Home-components/ProjectInfo.jsx";
import TaskContainer from "../../components/Tasks-components/TaskContainer.jsx";
function Home() {
  ...
  return (
    <div className="home">
      ...
      <Breadcrumb
        urlArray={[
          { name: "Projects", url: "Snapdrop" },
          { name: "Snapdrop", url: "/home" },
        ]}
      />
      {/* Both properties of info will be fetched from database */}
      <div className="home-projectInfo_h1">
        <ProjectInfo
          info={{
      ...
      <div className="home_tutorial">
        <div className="home_tutorial_guides">
          <small>LEARN HOW TO USE GUIDESTAR</small>
          <div className="home_tutorial_guides_status-link">
            <svg
              width="10"
              height="12"
              viewBox="0 0 10 12"
